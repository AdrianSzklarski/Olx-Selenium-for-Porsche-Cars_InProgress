...
class OlxPage:
    ...
    def get_driver(self):
        ...
        print(driver.find_element(By.XPATH, '//*[@id="root"]/div[1]/div[2]/form/div[3]/div[1]/div/div[3]/div/div/div[2]/div/div[' + str(self.radioValue.get()) + ']/label/input').click(), time.sleep(8))
